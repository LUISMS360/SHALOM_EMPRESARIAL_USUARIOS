...
{
    public partial class EliminarAgencia : Form
    {
        ...
        public EliminarAgencia()
        {
            ...
            conector = new ControladorAgencias();
        }
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("La agencia buscada no existe!");
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No ha ingresado la agencia a eliminar!");
                MessageBox.Show("Intentelo de nuevo");
            }
            else
            {
                if (this.conector.eliminarAgencia(lblNombreAgencia.Text))
                {
                    MessageBox.Show("Se ha elimando la agencia exitosamente!");
                }
                else
                {
                    MessageBox.Show("Ha ocurrido un error!");
                    MessageBox.Show("Verifique que la agencia no tenga ningun pedido alamacenado");
                }
            }
        }
    }
