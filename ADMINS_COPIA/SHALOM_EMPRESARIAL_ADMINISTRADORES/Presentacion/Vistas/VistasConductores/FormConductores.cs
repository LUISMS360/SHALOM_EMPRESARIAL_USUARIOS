...
namespace Presentacion.Vistas.VistasConductores
{
    public partial class FormConductores : Form
    {
        ...
        {
            abrirFormHija(new RegistrarConductores());
        }

        private void btnActualizarConductor_Click(object sender, EventArgs e)
        {
            abrirFormHija(new ActualizarConductor());
        }

        private void btnEliminarConductores_Click(object sender, EventArgs e)
        {
            abrirFormHija(new EliminarConductor());
        }

        private void btnVerConductores_Click(object sender, EventArgs e)
        {
            abrirFormHija(new VerConductores());
        }

        private void FormConductores_Load(object sender, EventArgs e)
        {
            abrirFormHija(new CragarConductores());
        }
    }
}