...
namespace Presentacion.Vistas.VistasCamiones
{
    public partial class FormCamiones : Form
    {
        ...
        private void btnRegsitrarCamionn_Click(object sender, EventArgs e)
        {
            abrirFormHija(new RegistrarCamiones());
        }

        private void btbActualizarCamion_Click(object sender, EventArgs e)
        {
            abrirFormHija(new ActualizarCamion());
        }

        private void btnEliminarCamion_Click(object sender, EventArgs e)
        {
            abrirFormHija(new EliminarCamion());
        }

        private void btnVerCamiones_Click(object sender, EventArgs e)
        {
            abrirFormHija(new VerCamiones());
        }

        private void FormCamiones_Load(object sender, EventArgs e)
        {
            abrirFormHija(new CargarCamiones());
        }
    }
}
